...
JNICALL Java_com_scanlibrary_ScanActivity_getScannedBitmap
...
JNICALL Java_com_scanlibrary_ScanActivity_getMagicColorBitmap
...
JNICALL Java_com_scanlibrary_ScanActivity_getBWBitmap
        (JNIEnv *env, jobject thiz, jobject bitmap) {
...
JNICALL Java_com_scanlibrary_ScanActivity_getGrayBitmap
        (JNIEnv *env, jobject thiz, jobject bitmap) {
...
JNICALL Java_com_scanlibrary_ScanActivity_getPoints
        (JNIEnv *env, jobject thiz, jobject bitmap) {
